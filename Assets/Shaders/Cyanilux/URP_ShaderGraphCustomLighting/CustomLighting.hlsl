...
*/
void AdditionalLights_float(float3 WorldPosition, float3 WorldNormal, float3 WorldView, half4 Shadowmask, float2 SmoothstepMinMax, float3 Power,
							out float3 Diffuse) {
...
void AdditionalLights_float(float3 WorldPosition, float3 WorldNormal, float3 WorldView, float2 SmoothstepMinMax,float3 Power,
							out float3 Diffuse) {
AdditionalLights_float(WorldPosition, WorldNormal, WorldView, half4(1,1,1,1), SmoothstepMinMax, Power, Diffuse);
}
